...
public class FileHandling {
    ...
    public static void writeFile(ArrayList<String> employees){
        Path path = Paths.get("C:/Users/justi/OneDrive/Desktop/CD DevShop 22/Java Programming/userNames.txt");
        try {
    ...
    static void readFile(ArrayList<String> employees){
        String line = "";
        Path path = Paths.get("C:/Users/justi/OneDrive/Desktop/CD DevShop 22/Java Programming/employees.txt");
